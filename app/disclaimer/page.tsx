        ...
        <>
            <main className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="space-y-12 text-gray-700 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">4. AI Chatbot Assistant Disclaimer</h2>
                        <div className="space-y-4">
                            <p>
                                <strong>{SITE_CONFIG.name}</strong> features an AI-powered chatbot assistant that uses artificial intelligence to answer questions about UAE expat life, budgeting, and related topics.
                            </p>
                            <p>
                                <strong>Important Limitations:</strong>
                            </p>
                            <ul className="list-disc pl-8 space-y-2">
                                <li>Chatbot responses are generated by AI and may contain errors, inaccuracies, or outdated information.</li>
                                <li>The chatbot does not provide professional, legal, financial, medical, or immigration advice.</li>
                                <li>Responses should be considered general guidance only and must be verified with official sources or qualified professionals.</li>
                                <li>We do not store your chat conversations, but messages are processed by third-party AI services (Google Gemini) according to their own terms.</li>
                                <li>The chatbot may not have access to the most current regulations, policies, or market conditions in the UAE.</li>
                                <li>We are not liable for any decisions, actions, or consequences resulting from information provided by the chatbot.</li>
                            </ul>
                            <p>
                                Do not share sensitive personal information in chatbot conversations. Use the chatbot at your own discretion and risk.
                            </p>
                        </div>
                    </section>
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">6. External Links</h2>
                        <div className="space-y-4">
                            <p>
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">7. No Warranties</h2>
                        <div className="space-y-4">
                            <p>
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">8. User Responsibility</h2>
                        <div className="space-y-4">
                            <p>
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">10. Changes to This Disclaimer</h2>
                        <div className="space-y-4">
                            <p>
                    ...
                    <section>
                        <h2 className="text-3xl font-bold text-gray-900 mb-6">12. Acknowledgment</h2>
                        <div className="space-y-4">
                            <p>
